...
class java_10_object_array 
{
    public static void main(String[] args) 
    {
        Scanner sc=new Scanner(System.in);
        String name,gend,addr,empid,cname,quali,sub,dept,tid,temp;
        int age,n;
        double salary;
        ...
        for(int i=0;i<n;i++)
        {
            ...
            tid=sc.nextLine();
            System.out.println();
            t[i]=new Teacher(name, gend, addr, age, empid, cname, quali, salary, sub, dept, tid);
        }
        for(int i=0;i<n;i++)
        {
            int m=i+1;
